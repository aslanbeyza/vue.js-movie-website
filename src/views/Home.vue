...
export default {
  ...
  data() {
    return {
      ...
      currentBackground: "", // Arka plan görseli için değişken
      randomMovies: [],
      maxStars: 5,
    };
  },
  ...
  created() {
    ...
    setInterval(this.setRandomBackground, 5000); // 30 saniyede bir arka planı değiştirecek
  },
  methods: {
    setRandomBackground() {
...
.carousel-container {
  ...
  image-rendering: smooth; /* Bazı tarayıcılarda kaliteyi artırabilir */
  image-rendering: crisp-edges; /* Keskin kenarlarla görseli render et */
}
...
.card {
  display: flex;
  flex-direction: column;
  justify-content: space-between; /* Başlık, görsel ve puan arasında boşluk */
  height: 100%;
}
