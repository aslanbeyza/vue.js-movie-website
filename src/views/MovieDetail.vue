...
html, body {
  ...
  padding: 0;
  height: 100%;
  background-color: #1c1c1c; /* Set the body background color */
}
...
.movie-detail {
  ...
  align-items: center;
  padding: 20px;
  background-color: #1c1c1c; /* Ensures the background color of the whole container is consistent */
  color: #f0f0f0;
...
.movie-content {
  ...
  border-radius: 8px;
  padding: 20px;
  background-color: #2a2a2a; /* Ensure content area has a dark background */
  width: 100%;
}
